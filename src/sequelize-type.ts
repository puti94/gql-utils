...
export type TableQueryMethods<T extends FieldMetadataMap, TOptions, TVariables, TData, Type extends TypeOptions> =
    ...
    useQuery<T = TData>
    (options?: (Type extends VueType.TypeName ? VueType.GqlQueryOptions<T, TVariables> : ReactType.GqlQueryOptions<T, TVariables>) & TOptions): (Type extends VueType.TypeName ?
...
export type TableGqlFields<T extends TableMetadataMap, Type extends TypeOptions = 'vue'> = {
    [key in keyof T]: {
        readonly one: TableQueryMethods<T[key]['fields'], QueryTableOptions<T[key]['fields']>, QueryOneVariables<T[key]['fields']>, ReturnOneType<T[key]['fields']>, Type>,
        readonly list: TableQueryMethods<T[key]['fields'], QueryTableOptions<T[key]['fields']>, QueryListVariables<T[key]['fields']>, ReturnListType<T[key]['fields']>, Type>,
        readonly listPage: TableQueryMethods<T[key]['fields'], QueryTableOptions<T[key]['fields']>, QueryListVariables<T[key]['fields']>, ReturnListPageType<T[key]['fields']>, Type>,
        ...
        readonly create?: TableMutationMethods<T[key]['fields'], Omit<PickConfig<T[key]['fields']>, 'deep'>, MutationInputVariables<T[key]['fields']>, ReturnOneType<T[key]['fields']>, Type>,
        readonly update?: TableMutationMethods<T[key]['fields'], Omit<PickConfig<T[key]['fields']>, 'deep'>, MutationUpdateVariables<T[key]['fields']>, ReturnOneType<T[key]['fields']>, Type>,
        readonly remove?: TableMutationMethods<T[key]['fields'], boolean, {
            id: string | number
        }, any, Type>,
    }
}
...
export type GqlApiConfig<T extends TableMetadataMap, Type extends TypeOptions = 'vue'> =
    (Type extends 'vue' ?
        {
